...
public class HttpServer
{
	...
	public static HttpServer getInstance( int port ) throws IOException
	{
		if (instance == null)
		{
...
//					String msg = "<html><body><h1>Directory " + uri + "</h1><br/>";
					String msg = "<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"><title>File Service</title></head><body><h1>Directory " + uri + "</h1><br/>";
		...
		try
		{
			if ( res == null )
			{
				...
				else
				{
	                ...
	                {
	                	fis = new FileInputStream( f );
						res = new Response( HTTP_OK, mime, fis);
