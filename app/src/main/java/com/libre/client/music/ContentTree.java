...
public class ContentTree {
	public final static String CREATOR = "GNaP MediaServer";
	public final static String ROOT_ID = "0";
	public final static String VIDEO_ID = "1";
	public final static String AUDIO_ID = "2";
	public final static String AUDIO_PLAYLIST_ID = "2-0";
	public final static String AUDIO_ARTISTS_ID = "2-1";
	public final static String AUDIO_ARTISTS_PREFIX = "2-1-";
	public final static String AUDIO_SONGS_ID = "2-2";
	public final static String AUDIO_ALBUMS_ID = "2-3";
	public final static String AUDIO_ALBUMS_PREFIX = "2-3-";
	public final static String AUDIO_GENRES_ID = "2-4";
	public final static String AUDIO_GENRES_PREFIX = "2-4-";
